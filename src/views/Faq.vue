<template>
  <div class="About">
    <div class="bg-3-wrapper-inv">
      <navbar />
      <section-0Faq />
    </div>
    <!-- <div class="bg-2-wrapper-inv">
      <section-1Faq />
    </div>
...
import Section0Faq from "../components/Sections/Section0Faq.vue";
// import Section1Faq from "../components/Sections/Section1About.vue";
// import Section2Faq from "../components/Sections/Section2About.vue";
...
// import SectionPlanet from "../components/Sections/SectionPlanet.vue";
...
.bg-3-wrapper-inv {
  background: url("~@/assets/imgs/bg-3-inv.png");
  background-repeat: no-repeat;
  background-size: 50%;
